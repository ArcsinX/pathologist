...
1. **LineMap**: Preprocessor must preserve mappable `(original_file, line, col)` for output offsets. Exported spans today use **preprocessed** line numbers from tree-sitter; remapping to original source is future work.
